          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-gray-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="flex justify-between items-center mb-6">
                <span className="text-3xl font-bold text-blue-600">GHS 1,400</span>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="flex justify-between items-center mb-6">
                <span className="text-3xl font-bold text-blue-600">GHS 400</span>
                <div className="flex items-center text-gray-600">
                  <Clock className="h-5 w-5 mr-2" />
                  <span>10 working days</span>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Easy online forms and step-by-step guidance make the process smooth.</p>
            </div>
          </div>
        </div>
      </section>
